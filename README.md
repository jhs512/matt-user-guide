...
CONTEXT.md와 관련 ADR을 읽고 02 티켓의 선행 조건을 확인한 뒤 진행해줘.
```
...
실험 목적, 모바일 가독성 기준, 합의한 요구, 제외 범위를 기록해줘.
...
미확인 사항을 확정 사실로 바꾸지 말고 테스트 경계는 먼저 확인해줘.
```
...
**순서:** `/diagnosing-bugs` → 오류 재현 → 원인 확인 → 수정·회귀 테스트
